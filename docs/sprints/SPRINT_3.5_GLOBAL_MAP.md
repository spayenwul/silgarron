...
### Система координат гексагональной сетки ⚠️ ВАЖНО (см. ADR-015)

**Принято решение использовать гибридную систему координат:**

1. **Визуальное представление:** Вертикальная Offset-система ("Pointy Top")
   - Гексагоны с острым верхом, столбцы идут вертикально
   - **Тематическое соответствие:** Визуально усиливает Склеритовый Хребет как центральную вертикальную ось
   - Интуитивно понятна игрокам ("иди на три гекса на север по хребту")
   - AI-нарратор естественно описывает движение вдоль "позвоночника"

2. **Внутренняя механика:** Cube/Axial Coordinates
   - Математически элегантная система для расчетов
   - **Тематическое соответствие (глубокое):** Три сбалансированные оси (`x + y + z = 0`) — метафора единства организма
   - Идеальна для pathfinding, расстояний, распространения эффектов (болезни, магия)
   - Органическое распространение — идеально ровные круги для "Кристаллической Скверны"

**Практическое применение:**
- Карта визуально ориентирована вертикально (Pointy Top), подчеркивая "позвоночник"
- Все внутренние расчеты используют Cube Coordinates
- Преобразование между системами — мгновенное (O(1))
- Детали в **ADR-015: Гибридная система гексагональных координат**

**Ресурс:** [Red Blob Games - Hexagonal Grids](https://www.redblobgames.com/grids/hexagons/)
...
Перед выполнением проверить на совместимость другим описаниям биомов в папке data/ и отдать предпочтение уже готовым схемам / дополнять их.
```yaml

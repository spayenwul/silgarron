...
**Оценка:** ✅ Согласно дизайну TDD, все команды, требующие физической симуляции (включая базовые атаки, уклонения и блоки), классифицируются как COMPLEX_TOOL_CALL. SIMPLE_LLM используется только для нарративных действий.
